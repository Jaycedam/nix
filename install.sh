...
fedora_pkgs() {
    ...
    sudo dnf install --setopt=install_weak_deps=False xdg-desktop-portal-gnome niri nautilus xdg-desktop-portal-wlr xdg-desktop-portal-gtk gnome-keyring pipewire tuned swaylock keyd -y >/dev/null
